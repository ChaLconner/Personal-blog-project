...
function NavBar() {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            // Handle desktop notification dropdown
            ...
            if (dropdown && dropdown.style.display === 'block' &&
                ...
                (!button || !button.querySelector('.bell-icon'))) {
            ...
            if (mobileDropdown && mobileDropdown.style.display === 'block' &&
                ...
                (!button || !button.parentElement.parentElement.contains(button))) {
    ...
    const NavBarUserAvatar = ({ size = "md", showName = false, nameClass = "ml-2 text-sm text-muted-foreground max-w-32 truncate" }) => {
        return (
    ...
    return (
        <nav className="flex justify-between items-center border-b border-ui-border sm:py-4 sm:px-[120px] h-12 sm:h-20 py-3 px-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            <div
                                ...
                                className="absolute right-0 top-full mt-2 w-[362px] max-h-[400px] p-0 border-none shadow-[2px_2px_16px_rgba(0,0,0,0.1)] rounded-xl bg-[#F9F8F6] overflow-hidden z-50 hidden"
                                style={{
                                    display: 'none'
                                }}
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent className="sm:hidden rounded-lg bg-[#F9F8F6] shadow-lg border-none mt-2 flex flex-col p-4" style={{
                    width: '375px',
                    height: 'auto',
                    left: '0px',
                    top: '48px',
                    ...
                    {isAuthenticated ? (
                            ...
                            <div className="flex items-center justify-between pb-4 mb-2">
                                ...
                                <div className="relative">
                                    ...
                                    <div
                                        ...
                                        className="absolute right-0 top-full mt-2 w-[320px] max-h-[300px] p-0 border-none shadow-[2px_2px_16px_rgba(0,0,0,0.1)] rounded-xl bg-[#F9F8F6] overflow-hidden z-50 hidden"
                                        style={{
                                            display: 'none'
                                        }}
                                        onClick={(e) => e.stopPropagation()}
                        ...
                        <>
                            <button
                                ...
                                className="px-8 py-3 rounded-full text-center text-foreground border border-foreground hover:border-muted-foreground hover:text-muted-foreground transition-colors cursor-pointer w-full"
                            >
                                Log in
                            </button>
                            <button
                                onClick={() => navigate("/signup")}
                                className="px-8 py-3 text-center text-white rounded-full bg-black hover:bg-muted-foreground transition-colors cursor-pointer w-full"
                            >
                                Sign up
                            </button>
                        </>
